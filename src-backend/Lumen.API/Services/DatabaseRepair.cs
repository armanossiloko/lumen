...
public static class DatabaseRepair
{
    public static void Apply(AppDbContext db)
    {
        ...
        TryAddColumn(db, "Pages", "Version", "INTEGER NOT NULL DEFAULT 1");
        ...
        EnsureTable(db, "UserPreferences", """
            CREATE TABLE IF NOT EXISTS "UserPreferences" (
                ...
                "PageWidth" TEXT NOT NULL DEFAULT 'wide',
                "RecentPagesJson" TEXT NOT NULL DEFAULT '[]'
            );
            """);

        TryAddColumn(db, "UserPreferences", "PageWidth", "TEXT NOT NULL DEFAULT 'wide'");
        TryAddColumn(db, "UserPreferences", "RecentPagesJson", "TEXT NOT NULL DEFAULT '[]'");
